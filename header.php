                            ...
                            <li>
                                <div class="unit flex-row unit-spacing-xs">
                                    ...
                                    <div class="unit-body">
                                        ...
                                        <h6><a href="tel:#">702 340 7305</a></h6>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="unit flex-row unit-spacing-xs">
                                    ...
                                    <div class="unit-body">
                                        ...
                                        <h6><a href="#">9600 Windborne Ave. Las Vegas NV 89147</a></h6>
                                    </div>
                                </div>
                            </li>
                            <li>
            ...
            <div class="rd-navbar-inner">
                <div class="rd-navbar-nav-wrap">
                    ...
                    <ul class="rd-navbar-nav">
                        <li class="active"><a  onclick="changeContent(this)" data-views = 'home' href="#">Home</a></li>
                        <li><a onclick="changeContent(this)" data-views = 'about' href="#">About Us</a></li>
                        <li><a onclick="changeContent(this)" data-views = 'contacts' href="#">Contacts</a></li>
                        <li><a onclick="changeContent(this)" data-views = 'conditions' href="#">Terms and Conditions</a></li>
                    </ul>
                </div>
            </div>
        </nav>
